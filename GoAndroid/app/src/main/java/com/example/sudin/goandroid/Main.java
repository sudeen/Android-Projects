...
import com.example.sudin.goandroid.library.DatabaseHandler;
import com.example.sudin.goandroid.library.UserFunctions;
 ...
 **/
    ...
    public void onRegisterButtonClick(View view) {
        Intent reg= new Intent(Main.this,Register.class);
        startActivity(reg);
    }
}